...
import CountryFlag from "react-native-country-flag";  //Essa biblioteca traz o icone da bandeira de uma país baseado no código que for passado na chamada desse componente.
